...
setup(
    ...
    url='https://github.com/amazy/python-orthanc-tools',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/amazy/python-orthanc-tools/issues',
        'Funding': 'https://mazy.be/orthanc',
        'Source': 'https://github.com/amazy/python-orthanc-tools/',
    },
)
